...
function asset_plugins($url = null){
    if( !empty($url) ){
...
function asset_js($url = null){
    if( !empty($url) ){
        return base_url( 'assets/js/' . $url );
    }
   return base_url().'assets/js/';
}


function asset_css($url = null){
    if( !empty($url) ){
...
function asset_script($url = null){
    if( !empty($url) ){
        return base_url( 'assets/scripts/' . $url );
    }
   return base_url().'assets/scripts/';
}
