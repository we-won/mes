var Inbox = function () {
    ...
    var loadInbox = function (el, name) {
        var url = $( '#email_inbox' ).data('source') + '/inbox-inbox';
    ...
    var loadMessage = function (el, name, resetMenu) {
        var url = $( '#email_inbox' ).data('source') + '/inbox-view';
    ...
    var initWysihtml5 = function () {
        $('.inbox-wysihtml5').wysihtml5({
            "stylesheets": [$('.inbox-wysihtml5').data('base') + "/plugins/bootstrap-wysihtml5/wysiwyg-color.css"]
        });
    }
    ...
    var loadCompose = function (el) {
        var url = $( '#email_inbox' ).data('source') + '/inbox-compose';
    ...
    var loadReply = function (el) {
        var url =  $( '#email_inbox' ).data('source') + '/reply';
